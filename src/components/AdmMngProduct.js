...
// import '../support/css/maintable.css';
// import '../support/table/Lato/Lato-Bold.ttf'
import '../support/table/font-awesome-4.7.0/css/font-awesome.css';
//import '../support/css/bootstraptable.css';

class AdmMngProduct extends Component {
        ...
        var listJSX = this.state.productList.map((item) => {
            ...
            return (
                <tr>
                    ...
                    <td>{item.category}</td>
                    <td><img src={`http://localhost:1997${item.image}`} alt={item.productname} width={100} /></td>
                    <td>{item.price}</td>
